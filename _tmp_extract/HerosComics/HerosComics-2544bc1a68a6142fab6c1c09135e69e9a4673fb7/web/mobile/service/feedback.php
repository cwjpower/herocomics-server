				...
				<div class="sevice-menu-area">
					<div data-role="navbar">
						<ul class="sevice-menu">
							...
							<li><a href="#" class="ui-btn-active"><img src="../img/service/service_m06_on.png" title="건의사항">건의사항</a></li>
						</ul>
					</div>
				</div>
				<div class="sevice-conts">
					...
					<div class="service-tb-area">
						<form id="item-list-form">
							<div class="btn-tb-write"><a href="<?php echo MOBILE_URL ?>/service/feedback_new.php" data-ajax="false">작성</a></div>
							<div class="service-tb">
								<ul>
									<li class="tb-header">
										<div class="fl help-tb-txt">제목<!-- label for="resChkAll">제목</label><input type="checkbox" id="resChkAll"> --></div>
						...
						?>
									<li>
										<div class="fl help-tb-txt">
											...
											<a href="feedback_view.php?pid=<?php echo $post_id ?>" data-ajax="false"><?php echo $post_title ?></a>
										</div>
