		...
		?>
			...
			<div data-role="main" class="ui-content join-area">
				...
				<form id="form-new-user">
					<div class="terms-box">
						<input type="checkbox" id="agree_term" name="agree_term" value="Y" required><label for="agree_term">BOOKtalk 이용약관</label><span class="mandatory txt-57c2ef">* 필수</span>
						<div class="terms-txt">
<br>
<h4>전자상거래(인터넷사이버몰) 표준약관</h4>
<br>
<br>
표준약관 제10023호<br>
(2015. 6. 26. 개정)<br>
...
<br>
						...
						<p class="terms-more"><a href="#">전체보기</a></p>
					</div>
					<div class="terms-box">
						<input type="checkbox" id="agree_privacy" name="agree_privacy" value="Y" required><label for="agree_privacy">BOOKtalk 개인정보취급방침</label><span class="mandatory txt-57c2ef">* 필수</span>
						<div class="terms-txt">
<br>
(주)비콘>('http://booktalk.world/mobile/'이하 'BOOKtalk')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br>
<(주)비콘>('BOOKtalk') 은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.<br>
○ 본 방침은부터 2016년 11월 1일부터 시행됩니다.<br>
<br>
1. 개인정보의 처리 목적 <(주)비콘>('http://booktalk.world/mobile/'이하 'BOOKtalk')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.<br>
가. 홈페이지 회원가입 및 관리<br>
...
<br>
2. 개인정보 파일 현황<br>
1. 개인정보 파일명 : test- 개인정보 항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 결혼여부, 취미, 학력, 주민등록번호, 신용카드정보, 은행계좌정보, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록, 법정대리인 이름, 법정대리인 휴대전화번호- 수집방법 : 홈페이지, 생성정보 수집 툴을 통한 수집- 보유근거 : 회원가입,본인 및 연령 확인, 서비스 이용 등- 보유기간 : 관련 법령에 의거- 관련법령 : 신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년, 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년, 대금결제 및 재화 등의 공급에 관한 기록 : 5년, 계약 또는 청약철회 등에 관한 기록 : 5년, 표시/광고에 관한 기록 : 6개월<br>
<br>
3. 개인정보의 처리 및 보유 기간① <(주)비콘>('BOOKtalk')은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다.② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.<br>
1.<홈페이지 회원가입 및 관리><홈페이지 회원가입 및 관리>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<관련 법령에 의거>까지 위 이용목적을 위하여 보유.이용됩니다.-보유근거 : 본인 확인 및 인증-관련법령 : 신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년-예외사유 : 2.<제화 또는 서비스 제공><제화 또는 서비스 제공>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<관련 법령에 의거>까지 위 이용목적을 위하여 보유.이용됩니다.-보유근거 : 본인 확인 및 인증-관련법령 : 대금결제 및 재화 등의 공급에 관한 기록 : 5년-예외사유 : 3.<마케팅 및 광고에의 활용><마케팅 및 광고에의 활용>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<관련 법령에 의거>까지 위 이용목적을 위하여 보유.이용됩니다.-보유근거 : 콘텐츠 추천 및 통계 서비스 이용-관련법령 : 1)신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년2) 표시/광고에 관한 기록 : 6개월-예외사유 : 선택항목으로 미동의시 서비스 이용 불가 4.<민원사무 처리><민원사무 처리>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<관련 법령에 의거>까지 위 이용목적을 위하여 보유.이용됩니다.-보유근거 : 고객 상담에 필요한 본인 확인 및 인증-관련법령 : 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년-예외사유 : <br>
4. 개인정보의 제3자 제공에 관한 사항① <(주)비콘>('http://booktalk.world/mobile/'이하 'BOOKtalk')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br>
② <(주)비콘>('http://booktalk.world/mobile/')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.<br>
1. <입점 출판사>- 개인정보를 제공받는 자 : 입점 출판사- 제공받는 자의 개인정보 이용목적 : 이메일, 휴대전화번호, 로그인ID, 성별, 생년월일, 이름, 결혼여부, 취미, 학력, 서비스 이용 기록, 접속 로그, 결제기록- 제공받는 자의 보유.이용기간: 관련 법령에 의거<br>
<br>
5. 개인정보처리 위탁① <(주)비콘>('BOOKtalk')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.<br>
1. <>- 위탁받는 자 (수탁자) : - 위탁하는 업무의 내용 : - 위탁기간 :<br>
② <(주)비콘>('http://booktalk.world/mobile/'이하 'BOOKtalk')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.<br>
6. 정보주체의 권리,의무 및 그 행사방법 이용자는 개인정보주체로서 다음과 같은 권리를 행사할 수 있습니다.<br>
① 정보주체는 (주)비콘(‘http://booktalk.world/mobile/’이하 ‘BOOKtalk) 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.1. 개인정보 열람요구2. 오류 등이 있을 경우 정정 요구3. 삭제요구4. 처리정지 요구② 제1항에 따른 권리 행사는(주)비콘(‘http://booktalk.world/mobile/’이하 ‘BOOKtalk) 에 대해 개인정보 보호법 시행규칙 별지 제8호 서식에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 <기관/회사명>(‘사이트URL’이하 ‘사이트명) 은(는) 이에 대해 지체 없이 조치하겠습니다.③ 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 <기관/회사명>(‘사이트URL’이하 ‘사이트명) 은(는) 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지 않습니다.④ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.<br>
<br>
7. 처리하는 개인정보의 항목 작성 ① <(주)비콘>('http://booktalk.world/mobile/'이하 'BOOKtalk')은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br>
1<홈페이지 회원가입 및 관리>- 필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 취미, 학력, 법정대리인 이름, 법정대리인 휴대전화번호- 선택항목 :<br>
<br>
8. 개인정보의 파기<(주)비콘>('BOOKtalk')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.<br>
...
<br>
9. 개인정보의 안전성 확보 조치 <(주)비콘>('BOOKtalk')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.<br>
1. 정기적인 자체 감사 실시개인정보 취급 관련 안정성 확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고 있습니다.2. 개인정보 취급 직원의 최소화 및 교육개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화 하여 개인정보를 관리하는 대책을 시행하고 있습니다.3. 내부관리계획의 수립 및 시행개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다.4. 해킹 등에 대비한 기술적 대책<(주)비콘>('BOOKtalk')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.5. 개인정보의 암호화이용자의 개인정보는 비밀번호는 암호화 되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고 있습니다.6. 접속기록의 보관 및 위변조 방지개인정보처리시스템에 접속한 기록을 최소 6개월 이상 보관, 관리하고 있으며, 접속 기록이 위변조 및 도난, 분실되지 않도록 보안기능 사용하고 있습니다.7. 개인정보에 대한 접근 제한개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의 부여,변경,말소를 통하여 개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며 침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있습니다.8. 문서보안을 위한 잠금장치 사용개인정보가 포함된 서류, 보조저장매체 등을 잠금장치가 있는 안전한 장소에 보관하고 있습니다.9. 비인가자에 대한 출입 통제개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다.<br>
<br>
10. 개인정보 보호책임자 작성<br>
① (주)비콘(‘http://booktalk.world/mobile/’이하 ‘BOOKtalk) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br>
▶ 개인정보 보호책임자 성명 :유상호직책 :개발팀장직급 :팀장연락처 :010-1234-5678, booktalk@booktalk.kr, ※ 개인정보 보호 담당부서로 연결됩니다.▶ 개인정보 보호 담당부서부서명 :담당자 :연락처 :, , ② 정보주체께서는 (주)비콘(‘http://booktalk.world/mobile/’이하 ‘BOOKtalk) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. (주)비콘(‘http://booktalk.world/mobile/’이하 ‘BOOKtalk) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br>
<br>
11. 개인정보 처리방침 변경<br>
...
<br>
					...
					<div class="terms-box">
						<input type="checkbox" id="agree-all"><label for="agree-all">이용약관, 개인정보 수집, 이용에 <span class="txt-57c2ef">모두 동의</span>합니다.</label>
					</div>
		...
		$(function() {
			$("#agree-all").click(function() {
				$("#agree_term, #agree_privacy").prop("checked", $(this).prop("checked"));
			});
			...
			$("#form-new-user").submit(function(e) {
				...
				$.ajax({
					type : "POST",
					url : "./ajax/join-1-new.php",
					data : $(this).serialize(),
					dataType : "json",
					success : function(res) {
						if (res.code == "0") {
							location.href = "join_2.php";
						} else {
							alert(res.msg);
						}
					}
