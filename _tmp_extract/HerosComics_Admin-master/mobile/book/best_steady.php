...
$best_books = lps_get_best_steady_books( $book_ids );
			...
			<div data-role="main" class="ui-content main-cont-area">
				...
				<div class="best-seller-area">
					<ul class="m-best-seller">
						<li><a href="best_steady.php" data-ajax="false" class="ui-btn-active ui-state-persist" data-transition="none">스테디셀러</a></li>
