...
// $admin_first_menu = wps_fancytree_root_node_by_name('wps_category_admin_menu');
		...
		<div class="wrapper">
			<header class="main-header">
				...
				<a href="<?php echo ADMIN_URL ?>/admin.php" class="logo">
					...
					<span class="logo-lg"><b>BOOK</b>TALK</span>
				</a>
				...
				<nav class="navbar navbar-static-top" role="navigation">
					...
					<div class="navbar-custom-menu pull-left">
						<ul class="nav navbar-nav">
							<li <?php echo stripos($lps_dir_path, '/users') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/users/">회원관리</a></li>
							<li <?php echo stripos($lps_dir_path, '/books') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/books/">책 관리</a></li>
							<li <?php echo stripos($lps_dir_path, '/pages') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/pages/">페이지 관리</a></li>
							<li <?php echo stripos($lps_dir_path, '/community') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/community/">커뮤니티 관리</a></li>
							<li <?php echo stripos($lps_dir_path, '/salestool') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/salestool/order_list.php">판매 관리</a></li>
							...
							<li <?php echo stripos($lps_dir_path, '/promotion') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/promotion/point_get_list.php">프로모션</a></li>
							<li <?php echo stripos($lps_dir_path, '/customer') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/customer/qna_list.php">문의관리</a></li>
						</ul>
					</div>
				</nav>
			</header>
