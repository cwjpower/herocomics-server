...
function lps_get_todays_new_book() {
 ...
 * Desc : 베스트 > 스테디셀러
 */
function lps_get_best_steady_books() {
	global $wdb;
 ...
 * Desc : 베스트 > 기간
 */
function lps_get_best_period_books( $period ) {
	global $wdb;
 ...
 * Desc : 베스트 > 장르별
 */
function lps_get_best_genre_books( $term_id ) {
	global $wdb;
