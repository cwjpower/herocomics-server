					...
					<form id="item-list-form">
						<div class="sevice-help-area">
							<ul class="help-menu list-item">
								<li><a href="qna.php" data-ajax="false">문의하기</a></li>
								<li class="on">문의내역</li>
							</ul>
							<div class="help-item-cont01">
								<div class="service-tb">
									<ul>
										<li class="tb-header">
											<div class="fl help-tb-txt"><label for="helpChkAll">제목</label><input type="checkbox" id="helpChkAll"></div>
							...
							?>
										<li>
											<div class="fl help-tb-txt">
												...
												<a href="qna_view.php?pid=<?php echo $post_id ?>" data-ajax="false"><?php echo $post_title ?></a>
											</div>
											<div class="fl btn-response">
												<!-- span><small><?php echo $post_date_label ?></small></span> -->
												<?php echo $reply_icon ?>
											</div>
										</li>
							<?php
