			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li>?꾨줈紐⑥뀡</li>
						<li class="active"><b>?ъ씤???곷┰?댁뿭</b></li>
					</ol>
				</div>
				...
				<div class="content body">
						...
						<div class="box-body">
							<form id="search-form" class="form-horizontal">
								<table class="table table-bordered ls-table">
									...
									<tbody>
										<tr class="hide">
											<td class="item-label">援щ텇</td>
											<td>
												<div class="col-sm-12">
													<label style="margin-right: 20px;">
														<input type="radio" name="pt" value="A" <?php echo strcmp($pt, 'A') ? '' : 'checked'; ?>>?꾩껜
													</label>
													<label style="margin-right: 20px;">
														<input type="radio" name="pt" value="G" <?php echo strcmp($pt, 'G') ? '' : 'checked'; ?>>吏湲?
													</label>
													<label>
														<input type="radio" name="pt" value="S" <?php echo strcmp($pt, 'S') ? '' : 'checked'; ?>>?ъ슜
													</label>
												</div>
											</td>
										</tr>
										<tr>
											<td class="item-label">寃?됱뼱</td>
											<td>
												<div class="col-sm-3">
													<select name="qa1" class="form-control">
														<optgroup label="?ㅼ썙??寃??>
															<option value="">-?좏깮-</option>
															<option value="u.user_name" <?php echo strcmp($qa1, 'u.user_name') ? '' : 'selected'; ?>>?대쫫</option>
															<option value="u.display_name" <?php echo strcmp($qa1, 'u.display_name') ? '' : 'selected'; ?>>?됰꽕??/option>
															<option value="u.user_login" <?php echo strcmp($qa1, 'u.user_login') ? '' : 'selected'; ?>>怨꾩젙(Email)</option>
															<option value="u.user_email" <?php echo strcmp($qa1, 'u.user_email') ? '' : 'selected'; ?>>?대찓??二쇱냼</option>
															<option value="u.mobile" <?php echo strcmp($qa1, 'u.mobile') ? '' : 'selected'; ?>>?곕씫泥?/option>
														</optgroup>
													</select>
												</div>
												<div class="col-sm-3">
										...
										<tr>
											<td class="item-label">湲곌컙</td>
											<td>
												<div class="col-sm-5">
													<a class="btn btn-info btn-xs wps-date" title="0">?ㅻ뒛</a>
													<a class="btn btn-info btn-xs wps-date" title="1">?댁젣</a>
													<a class="btn btn-info btn-xs wps-date" title="7">理쒓렐 7??/a>
													<a class="btn btn-info btn-xs wps-date" title="15">理쒓렐 15??/a>
													<a class="btn btn-info btn-xs wps-date" title="30">理쒓렐 30??/a>
													<a class="btn btn-info btn-xs wps-date" title="60">理쒓렐 60??/a>
													<a class="btn btn-info btn-xs wps-date" title="90">理쒓렐 90??/a>
												</div>
												<div class="col-sm-7">
										...
										<tr>
											<td colspan="2">
												<div class="col-sm-12 text-center">
													<button type="submit" class="btn btn-primary btn-flat">寃??/button> &nbsp;
													<button type="button" id="reset-btn" class="btn btn-default btn-flat">珥덇린??/button>
												</div>
											</td>
										</tr>
									</tbody>
					...
					<div class="box box-primary">
						<div class="box-header">
							<div>
								<i class="fa fa-circle-o text-yellow"></i> 寃곌낵: <b><?php echo number_format($total_count) ?></b>
							</div>
						</div>
						<div class="box-body">
