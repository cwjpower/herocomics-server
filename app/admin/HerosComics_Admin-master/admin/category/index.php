...
?>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="alert alert-warning alert-dismissable">
								...
								<ol>
									<li>카테고리 선택 후 마우스의 오른쪽 버튼을 클릭하시면 편집, 삭제 및 하위 카테고리 추가 기능을 사용할 수 있습니다. </li>
									<li>Drag &amp; Drop 기능을 이용하여 카테고리 위치를 변경하실 수 있습니다.</li>
								</ol>
							</div>
						</div>
					</div>
			...
			$(function() {
				...
				$("#tree-act-save").click(function() {
					$.ajax({
						type : "POST",
						url : "./ajax/fancytree-node-save.php",
						data : {
				...
				$("#tree").fancytree({
					...
					source: {
						url: "./ajax/fancytree_node.php?tkey=<?php echo $taxonomy ?>"
					},
					debugLevel: 0,
					contextMenu: {
						menu: {
				...
				function deleteNode(node) {
					...
					$.ajax({
						type : "POST",
						url : "./ajax/fancytree-node-delete.php",
						data : {
							termID : node.key
						},
						dataType : "json",
				...
				function moveNode( other, node ) {
					...
					$.ajax({
						type : "POST",
						url : "./ajax/fancytree-node-move.php",
						data : {
							"termID" : other.key,
							"parentID" : node.key,
							"nodeKeys" : nodeKeys,
