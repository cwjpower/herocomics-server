    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo ADMIN_URL ?>/story/">스토리 관리</a></li>
                <li><a href="<?php echo ADMIN_URL ?>/story/world_list.php">세계관 관리</a></li>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default" style="margin-top:3rem;">
                        ...
                        <div class="panel-heading"><!--<i class="fa fa-film"></i>--> 세계관 등록 / 수정 </div>
                        <div class="panel-body">
                            <form enctype="multipart/form-data" id="form-news" method="POST">
                                <input type="hidden" name="is_new" value="Y">

                                <div class="form-group">
                                    <label for="exampleInputEmail1">세계관 제목</label>
                                    <input type="text" class="form-control" id="news-title" name="news_title" placeholder="세계관제목" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">세계관 소제목</label>
                                    <input type="text" class="form-control" id="news-sub-title" name="news_sub_title" placeholder="세계관 소제목" required>
                                </div>
                                <div class="radio">
                                    <label>
                                ...
                                <div class="form-group">
                                    <label for="news-content">세계관내용 </label>
                                ...
                                <a href="world_list.php" class="btn btn-default " style="margin-left:3rem">리스트로 가기</a>
                            </form>
                        </div>
