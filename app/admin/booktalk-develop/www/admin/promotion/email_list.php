...
?>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<h1>
						EMAIL 전송 내역
						<a href="./email_new.php" class="btn btn-info btn-sm">EMAIL 작성</a>
					</h1>
					<ol class="breadcrumb">
						<li><a href="<?php echo ADMIN_URL ?>/admin.php"><i class="fa fa-dashboard"></i> Home</a></li>
						<li>프로모션</li>
						<li class="active"><b>EMAIL 전송 내역</b></li>
					</ol>
				</div>
				...
				<div class="content body">
					...
					if ( !empty($rows) ) {
						...
						foreach ( $rows as $key => $val ) {
							...
							$prom_content_label = substr(strip_tags($prom_content), 0, 100);
							$user_count = $val['user_count'];
							$created_dt = $val['created_dt'];
					?>
									<tr class="show_content" id="email-<?php echo $ID ?>">
										<td><?php echo $list_no ?></td>
										<td><?php echo $prom_title ?></td>
										<td><?php echo $prom_content_label ?></td>
