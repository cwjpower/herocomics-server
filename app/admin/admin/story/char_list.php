...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            ...
            <p style="margin-top:1rem;">스토리 영역에 노출되는 캐릭터 / 팀 콘텐츠를 관리합니다.</p>
        </div>
                    ...
                    <form id="search-form" class="form-inline">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <a href="./news_new.php" class="btn btn-default">캐릭터 등록</a>
                                <a href="./news_new.php" class="btn btn-default">팀 등록</a>
                                <button type="button" id="btn-delete" class="btn btn-danger ">선택 삭제</button>
                            </div>
