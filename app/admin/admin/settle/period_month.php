			...
			<div class="content-wrapper">
				...
				<div class="content body">
					<div class="box box-default">
						...
						<?php 
						foreach ($wps_period_coverage as $key => $val) {
							$surl = 'period_' . $key . '.php';
							$sfile = basename($_SERVER['PHP_SELF']);
						?>
										<a href="<?php echo $surl ?>" class="btn <?php echo strpos($sfile, $key) !== false ? 'btn-success' : 'btn-info'; ?> btn-flat"><?php echo $val ?></a>
						<?php
						}
						?>
									</div>
