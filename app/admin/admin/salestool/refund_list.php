			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><b>환불 신청 관리</b></li>
					</ol>
				</div>
											...
											<td>
												<div class="col-sm-3">
													<select name="qa2" class="form-control">
														<optgroup label="키워드 검색">
															<option value="">-선택-</option>
															<option value="o.created_dt" <?php echo strcmp($qa2, 'o.created_dt') ? '' : 'selected'; ?>>주문일</option>
															<option value="o.updated_dt" <?php echo strcmp($qa2, 'o.updated_dt') ? '' : 'selected'; ?>>환불 접수일</option>
															<option value="o.refunded_dt" <?php echo strcmp($qa2, 'o.refunded_dt') ? '' : 'selected'; ?>>환불 완료일</option>
														</optgroup>
													</select>
												</div>
											...
											<td>
												<div class="col-sm-3">
													<select name="qa3" class="form-control">
														<option value="">-선택-</option>
											<?php 
											foreach ($wps_refund_status as $key => $val) {
											?>
