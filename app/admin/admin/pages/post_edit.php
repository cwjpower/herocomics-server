				...
				<div class="content body">
					<form id="item-new-form" method="post" enctype="multipart/form-data">
						...
						foreach ($wps_notice_coverage as $key => $val ) {
							$checked = in_array($key, $post_type_area) ? 'checked' : '';
						?>
										<label><input type="checkbox" class="post_type_area" name="post_type_area[]" value="<?php echo $key ?>" <?php echo $checked ?>><?php echo $val ?></label> &nbsp;
						<?php 
						}
						?>
									</div>
