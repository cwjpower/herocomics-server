...
/*
 * 2016.08.25	softsyw
 * Desc : 관리자가 등록대기(1000)중인 서적에 대해서 승인/거절을 처리하는 화면
 */
					...
					<div class="box box-info">
						<div class="box-body">
							...
							<div class="alert alert-danger">
								<h3><i class="fa fa-chevron-circle-right"></i> 거절 사유</h3>
						...
						success : function(res) {
							if (res.code == "0") {
								if (res.result == "0") {
									...
									alert("승인했습니다.");
									location.href = "book_req_new_list.php";
								}
							} else {
								alert(res.msg);
							}
