...
// 							$created_dt = substr($val['created_dt'], 2, 14);
					...
					?>
									<tr>
										<td><?php echo $pkg_label ?> <a href="book_res_new.php?id=<?php echo $book_id ?>"><?php echo $book_title ?></a></td>
