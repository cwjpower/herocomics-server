...
if ( !empty($_POST['userlogin']) && !empty($_POST['passwd']) ) {
    ...
    // === 디버깅 === ✅
    error_log("POST 받음!");
    error_log("userlogin: " . $_POST['userlogin']);
    error_log("passwd exists: " . (!empty($_POST['passwd']) ? 'YES' : 'NO'));
    // === 디버깅 끝 === ✅
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        if ( wps_get_ie_version() > 4 ) {
            ...
            <form role="form" method="post" action="" id="admin-login-form">
...
<script>
     ...
     */
    console.log('iCheck disabled - using native HTML form');
</script>
</body>
</html>