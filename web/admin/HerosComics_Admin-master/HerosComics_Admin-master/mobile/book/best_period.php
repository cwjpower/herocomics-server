...
$best_books = lps_get_best_period_books( $period, $book_ids );
			...
			<div data-role="main" class="ui-content main-cont-area">
				...
				<div class="best-seller-area">
					<ul class="m-best-seller">
						...
						<li><a href="best_genre.php" data-ajax="false" data-transition="none">장르별</a></li>
						<li><a href="best_period.php" data-ajax="false" class="ui-btn-active ui-state-persist" data-transition="none">기간별</a></li>
					</ul>
						...
						<div class="best-seller-select">
							<form action="form-search">
								<select name="period" id="period">
									...
									<option value="week" <?php echo strcmp($period, 'week') ? '' : 'selected'; ?>>주간</option>
									<option value="month" <?php echo strcmp($period, 'month') ? '' : 'selected'; ?>>월간</option>
								</select>
							</form>
						</div>
