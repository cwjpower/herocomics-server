...
?>			
			...
			<div data-role="main" class="ui-content book-search-area">
				...
				<ul class="m-search">
			    	...
			    	<li><a href="search3.php?glk=<?php echo $glk ?>" class="ui-btn-active ui-state-persist" data-ajax="false">작가(<?php echo $search_authors_count ?>)</a></li>
		...
		<?php 
		if (!empty($search_authors)) {
			foreach ($search_authors as $key => $val) {
				$user_id = $val['ID'];
		...
		?>
			    	<div data-role="collapsible" data-collapsed="true">
						<h1 class="publisher-tit"><?php echo $user_name ?>
							<div class="book-search-r book-arrow-down book-author-arrow">보기</div>
						</h1>
						<ul class="book-author">
							<li><strong>작가소개</strong>
								<div class="book-author-txt">
						...
						if ($book_count > 0) {
							foreach ($book_rows as $k => $v) {
								...
								$book_cover = $v['cover_img'];
						?>
									<dl>
										<dt><a href="<?php echo MOBILE_URL ?>/book/book.php?id=<?php echo $book_id ?>" data-ajax="false"><img src="<?php echo $book_cover ?>" title="책 표지"></a></dt>
										<dd><a href="<?php echo MOBILE_URL ?>/book/book.php?id=<?php echo $book_id ?>" data-ajax="false"><?php echo $book_title ?></a></dd>
									</dl>
						<?php 
							}
						}
						?>
									<dl>
										<dt><a href="#"><img src="../img/book_img/book_sample01.jpg" alt=""></a></dt>
										<dd><a href="#">롤리타 불안의 책 한밤의 아이들</a></dd>
									</dl>
									<dl>
										<dt><a href="#"><img src="../img/book_img/book_sample01.jpg" alt=""></a></dt>
										<dd><a href="#">못 참는 아이 욱하는 부모 </a></dd>
									</dl>
								</div>
								<!-- p class="book-author-more"><a href="#">전체보기</a></p> -->
							</li>
						</ul>
					</div>			    	
		<?php 
