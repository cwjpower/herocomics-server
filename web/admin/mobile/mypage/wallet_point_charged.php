			...
			<div data-role="main" class="ui-content mypage-area">
				...
				<div class="mypage-cont">
					...
					<ul class="history-menu list-item">
						<li><a href="wallet_point.php" data-ajax="false">사용 내역</a></li>
						<li class="on">충전 내역</li>
					</ul>
					<div class="list-item-cont01">
						<p>최근 <?php echo $period ?>개월 포인트 충전 내역 조회</p>
						<div class="sel-month">
				...
				?>
							<li>
								...
								<div class="history history-txt"><?php echo $paymethod ?> 충전<span class="history-list-r"><?php echo number_format($cash) ?>포인트</span></div>
							</li>
				<?php 
					}
				}
